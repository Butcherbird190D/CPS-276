	...
	public function validateForm($GlobalPost, $elementsArr){
		foreach($elementsArr as $k=>$v){
			...
			if($elementsArr[$k]['type'] === "text"){
				...
				/*HERE I PUT THE VALUES INTO THE ARRAY TO MAKE IT STICKY EXCEPT FOR PASSWORD FIELDS. */
				if ($k !== "password") { // Exclude password field from being sticky
			...
			/*THIS CHECKS FOR ANY RADIO BUTTONS THAT ARE SELECTED. IT ALSO WILL CHECK IF A RADIO GROUP IS REQUIRED TO BE SELECTED BY CHECKING THE ACTION (REQUIRED OR NOT REQUIRED).  IT ALSO MAKES THE FORM STICKY */
